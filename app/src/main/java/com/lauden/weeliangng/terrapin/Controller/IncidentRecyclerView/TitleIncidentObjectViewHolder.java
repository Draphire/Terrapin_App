...
public class TitleIncidentObjectViewHolder extends ParentViewHolder {
    ...
    public TitleIncidentObjectViewHolder(@NonNull View itemView) {
        super(itemView);
    ...
    public void bind(@NonNull TitleIncidentObject titleIncidentObject) {
        mRecipeTextView.setText(titleIncidentObject.getName());
    }
