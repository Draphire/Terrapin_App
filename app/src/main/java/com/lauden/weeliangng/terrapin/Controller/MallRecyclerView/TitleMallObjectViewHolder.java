...
public class TitleMallObjectViewHolder extends ParentViewHolder {
    ...
    public TitleMallObjectViewHolder(@NonNull View itemView) {
        super(itemView);
    ...
    public void bind(@NonNull TitleMallObject titleMallObject) {
        mRecipeTextView.setText(titleMallObject.getName());
    }
