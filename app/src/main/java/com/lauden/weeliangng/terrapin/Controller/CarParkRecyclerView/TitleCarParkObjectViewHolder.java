...
public class TitleCarParkObjectViewHolder extends ParentViewHolder {
    ...
    public TitleCarParkObjectViewHolder(@NonNull View itemView) {
        super(itemView);
    ...
    public void bind(@NonNull TitleCarParkObject titleCarParkObject) {
        mRecipeTextView.setText(titleCarParkObject.getName());
    }
